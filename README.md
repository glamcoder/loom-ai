...
> **v0.1.0 — deterministic developer preview.** Loom AI v0 makes **no LLM calls** and **no network calls**. It turns `.loom` source into files, a provider-neutral Program IR, and run traces using only your inputs and local files. See [Status](#status).
...
Loom AI is most useful for teams with more than one repo, more than one coding
...
This file was generated by Loom AI.
"""
}
...
## What Loom AI is good for today
...
Loom AI v0 is a deterministic build/workflow layer for AI artifacts. It is:
...
- **Loom AI is a temporary working name** and may change before a stable release.
