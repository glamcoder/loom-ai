    ...
    items: [
      {
        ...
        desc: "Install Loom AI and go from zero to a generated artifact, trace, and passing test in about five minutes.",
      },
      {
        ...
        nav: "Concepts",
        title: "Concepts",
        desc: "The Loom AI mental model: modules, prompts, programs, steps, effects, outputs, tests, traces, and the Program IR.",
      },
      {
        slug: "docs/cli.html",
        from: "docs/cli.md",
    ...
    items: [
      {
        ...
        desc: "The authoritative reference for the Loom AI DSL as implemented in v0: grammar, types, effects, expressions, and rules.",
      },
      {
    ...
    items: [
      {
        ...
        desc: "The example .loom programs that ship with Loom AI and what each demonstrates.",
      },
      {
      ...
      },
      {
        ...
        nav: "Comparisons",
        title: "Comparisons",
        desc: "How Loom AI relates to BAML, DSPy, LangGraph, promptfoo, Make, and template engines.",
      },
      {
        ...
        nav: "Roadmap",
        title: "Roadmap",
        desc: "Where Loom AI is going: llm.complete, output parsing/validation, workflow control, and packages.",
      },
      {
        ...
        desc: "A design sketch for the first nondeterministic operation Loom AI will add — behind a mock provider first.",
      },
    ],
  },
];
